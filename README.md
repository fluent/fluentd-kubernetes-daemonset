...
- `v1.7.4-debian-elasticsearch7-2.1,v1.7-debian-elasticsearch7-2,v1-debian-elasticsearch` [docker-image/v1.7/debian-elasticsearch7/Dockerfile](docker-image/v1.7/debian-elasticsearch7/Dockerfile)
- `v1.7.4-debian-elasticsearch6-2.1,v1.7-debian-elasticsearch6-2` [docker-image/v1.7/debian-elasticsearch6/Dockerfile](docker-image/v1.7/debian-elasticsearch6/Dockerfile)
- `v1.7.4-debian-loggly-2.1,v1.7-debian-loggly-2` [docker-image/v1.7/debian-loggly/Dockerfile](docker-image/v1.7/debian-loggly/Dockerfile)
- `v1.7.4-debian-logentries-2.1,v1.7-debian-logentries-2` [docker-image/v1.7/debian-logentries/Dockerfile](docker-image/v1.7/debian-logentries/Dockerfile)
- `v1.7.4-debian-cloudwatch-2.1,v1.7-debian-cloudwatch-2` [docker-image/v1.7/debian-cloudwatch/Dockerfile](docker-image/v1.7/debian-cloudwatch/Dockerfile)
- `v1.7.4-debian-stackdriver-2.1,v1.7-debian-stackdriver-2` [docker-image/v1.7/debian-stackdriver/Dockerfile](docker-image/v1.7/debian-stackdriver/Dockerfile)
- `v1.7.4-debian-s3-2.1,v1.7-debian-s3-2` [docker-image/v1.7/debian-s3/Dockerfile](docker-image/v1.7/debian-s3/Dockerfile)
- `v1.7.4-debian-syslog-2.1,v1.7-debian-syslog-2` [docker-image/v1.7/debian-syslog/Dockerfile](docker-image/v1.7/debian-syslog/Dockerfile)
- `v1.7.4-debian-forward-2.1,v1.7-debian-forward-2` [docker-image/v1.7/debian-forward/Dockerfile](docker-image/v1.7/debian-forward/Dockerfile)
- `v1.7.4-debian-gcs-2.1,v1.7-debian-gcs-2` [docker-image/v1.7/debian-gcs/Dockerfile](docker-image/v1.7/debian-gcs/Dockerfile)
- `v1.7.4-debian-graylog-2.1,v1.7-debian-graylog-2` [docker-image/v1.7/debian-graylog/Dockerfile](docker-image/v1.7/debian-graylog/Dockerfile)
- `v1.7.4-debian-papertrail-2.1,v1.7-debian-papertrail-2` [docker-image/v1.7/debian-papertrail/Dockerfile](docker-image/v1.7/debian-papertrail/Dockerfile)
- `v1.7.4-debian-logzio-2.1,v1.7-debian-logzio-2` [docker-image/v1.7/debian-logzio/Dockerfile](docker-image/v1.7/debian-logzio/Dockerfile)
- `v1.7.4-debian-kafka-2.1,v1.7-debian-kafka-2` [docker-image/v1.7/debian-kafka/Dockerfile](docker-image/v1.7/debian-kafka/Dockerfile)
- `v1.7.4-debian-kinesis-2.1,v1.7-debian-kinesis-2` [docker-image/v1.7/debian-kinesis/Dockerfile](docker-image/v1.7/debian-kinesis/Dockerfile)
