...
- `v1.4.2-debian-elasticsearch-2.0,v1.4-debian-elasticsearch-2` [docker-image/v1.4/debian-elasticsearch/Dockerfile](docker-image/v1.4/debian-elasticsearch/Dockerfile)
- `v1.4.2-debian-loggly-2.0,v1.4-debian-loggly-2` [docker-image/v1.4/debian-loggly/Dockerfile](docker-image/v1.4/debian-loggly/Dockerfile)
- `v1.4.2-debian-logentries-2.0,v1.4-debian-logentries-2` [docker-image/v1.4/debian-logentries/Dockerfile](docker-image/v1.4/debian-logentries/Dockerfile)
- `v1.4.2-debian-cloudwatch-2.0,v1.4-debian-cloudwatch-2` [docker-image/v1.4/debian-cloudwatch/Dockerfile](docker-image/v1.4/debian-cloudwatch/Dockerfile)
- `v1.4.2-debian-stackdriver-2.0,v1.4-debian-stackdriver-2` [docker-image/v1.4/debian-stackdriver/Dockerfile](docker-image/v1.4/debian-stackdriver/Dockerfile)
- `v1.4.2-debian-s3-2.0,v1.4-debian-s3-2` [docker-image/v1.4/debian-s3/Dockerfile](docker-image/v1.4/debian-s3/Dockerfile)
- `v1.4.2-debian-syslog-2.0,v1.4-debian-syslog-2` [docker-image/v1.4/debian-syslog/Dockerfile](docker-image/v1.4/debian-syslog/Dockerfile)
- `v1.4.2-debian-forward-2.0,v1.4-debian-forward-2` [docker-image/v1.4/debian-forward/Dockerfile](docker-image/v1.4/debian-forward/Dockerfile)
- `v1.4.2-debian-gcs-2.0,v1.4-debian-gcs-2` [docker-image/v1.4/debian-gcs/Dockerfile](docker-image/v1.4/debian-gcs/Dockerfile)
- `v1.4.2-debian-graylog-2.0,v1.4-debian-graylog-2` [docker-image/v1.4/debian-graylog/Dockerfile](docker-image/v1.4/debian-graylog/Dockerfile)
- `v1.4.2-debian-papertrail-2.0,v1.4-debian-papertrail-2` [docker-image/v1.4/debian-papertrail/Dockerfile](docker-image/v1.4/debian-papertrail/Dockerfile)
- `v1.4.2-debian-logzio-2.0,v1.4-debian-logzio-2` [docker-image/v1.4/debian-logzio/Dockerfile](docker-image/v1.4/debian-logzio/Dockerfile)
- `v1.4.2-debian-kafka-2.0,v1.4-debian-kafka-2` [docker-image/v1.4/debian-kafka/Dockerfile](docker-image/v1.4/debian-kafka/Dockerfile)
- `v1.4.2-debian-kinesis-2.0,v1.4-debian-kinesis-2` [docker-image/v1.4/debian-kinesis/Dockerfile](docker-image/v1.4/debian-kinesis/Dockerfile)
